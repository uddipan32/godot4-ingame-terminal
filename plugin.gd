...
func _enter_tree():
	...
	self.add_custom_type("Console", 'Control', preload("res://addons/godot4-ingame-terminal/src/scripts/Console.gd"), preload("res://addons/godot4-ingame-terminal/icon.png"))
